# Contributing to [Opentracing Contrib Instrumentation](https://github.com/armutcom/armut-opentracing-contrib-instrumentation)
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<user-name>/armut-opentracing-contrib-instrumentation.git
   # Navigate to the newly cloned directory
   cd <folder-name>
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/armutcom/armut-opentracing-contrib-instrumentation
   ```
